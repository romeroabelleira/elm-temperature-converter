...
var $author$project$TemperatureConverter$DegreesCelsius = {$: 'DegreesCelsius'};
var $author$project$TemperatureConverter$DegreesFahrenheit = {$: 'DegreesFahrenheit'};
var $author$project$TemperatureConverter$Kelvin = {$: 'Kelvin'};
var $author$project$TemperatureConverter$Temperature = F2(
	function (value, unit) {
		return {unit: unit, value: value};
	});
var $author$project$TemperatureConverter$absolute_min_temp = A2($author$project$TemperatureConverter$Temperature, 0.0, $author$project$TemperatureConverter$Kelvin);
var $elm_explorations$test$Expect$Relative = function (a) {
	return {$: 'Relative', a: a};
};
var $author$project$TemperatureConverterTest$accuracy = $elm_explorations$test$Expect$Relative(0.001);
var $author$project$TemperatureConverter$convertTemp = F2(
	function (temperature, unit) {
		convertTemp:
		while (true) {
			switch (unit.$) {
				case 'Kelvin':
					var _v1 = temperature.unit;
					switch (_v1.$) {
						case 'DegreesCelsius':
							return A2($author$project$TemperatureConverter$Temperature, temperature.value + 273.15, $author$project$TemperatureConverter$Kelvin);
						case 'DegreesFahrenheit':
							return A2($author$project$TemperatureConverter$Temperature, ((temperature.value + 459.67) * 5) / 9, $author$project$TemperatureConverter$Kelvin);
						default:
							return temperature;
					}
				case 'DegreesCelsius':
					var _v2 = temperature.unit;
					switch (_v2.$) {
						case 'DegreesCelsius':
							return temperature;
						case 'DegreesFahrenheit':
							var $temp$temperature = A2($author$project$TemperatureConverter$convertTemp, temperature, $author$project$TemperatureConverter$Kelvin),
								$temp$unit = $author$project$TemperatureConverter$DegreesCelsius;
							temperature = $temp$temperature;
							unit = $temp$unit;
							continue convertTemp;
						default:
							return A2($author$project$TemperatureConverter$Temperature, temperature.value - 273.15, $author$project$TemperatureConverter$DegreesCelsius);
					}
				default:
					var _v3 = temperature.unit;
					switch (_v3.$) {
						case 'DegreesCelsius':
							var $temp$temperature = A2($author$project$TemperatureConverter$convertTemp, temperature, $author$project$TemperatureConverter$Kelvin),
								$temp$unit = $author$project$TemperatureConverter$DegreesFahrenheit;
							temperature = $temp$temperature;
							unit = $temp$unit;
							continue convertTemp;
						case 'DegreesFahrenheit':
							return temperature;
						default:
							return A2($author$project$TemperatureConverter$Temperature, ((temperature.value * 9) / 5) - 459.67, $author$project$TemperatureConverter$DegreesFahrenheit);
					}
			}
		}
	});
...
var $author$project$TemperatureConverter$absolute_max_temp = A2(
	$author$project$TemperatureConverter$Temperature,
	1.4168 * A2($elm$core$Basics$pow, 10, 32),
	$author$project$TemperatureConverter$Kelvin);
...
var $elm_explorations$test$Shrink$map = $elm_explorations$test$Lazy$List$map;
var $author$project$TemperatureConverterTest$fuzzyDegreesCelsius = function () {
	var shrinker = function (t) {
		return A2(
			$elm_explorations$test$Shrink$map,
			function (x) {
				return A2($author$project$TemperatureConverter$Temperature, x, $author$project$TemperatureConverter$DegreesCelsius);
			},
			$elm_explorations$test$Shrink$float(t.value));
	};
	var generator = A2(
		...
		A2($elm$random$Random$float, $author$project$TemperatureConverter$absolute_min_temp.value - 273.15, $author$project$TemperatureConverter$absolute_max_temp.value - 273.15));
	return A2($elm_explorations$test$Fuzz$custom, generator, shrinker);
}();
var $author$project$TemperatureConverterTest$fuzzyDegreesFahrenheit = function () {
	var shrinker = function (t) {
		return A2(
			$elm_explorations$test$Shrink$map,
			function (x) {
				return A2($author$project$TemperatureConverter$Temperature, x, $author$project$TemperatureConverter$DegreesFahrenheit);
			},
			$elm_explorations$test$Shrink$float(t.value));
	};
	var generator = A2(
		...
		A2($elm$random$Random$float, (($author$project$TemperatureConverter$absolute_min_temp.value * 9) / 5) - 459.67, ((1000 * 9) / 5) - 459.67));
	return A2($elm_explorations$test$Fuzz$custom, generator, shrinker);
}();
var $author$project$TemperatureConverterTest$fuzzyKelvin = function () {
	var shrinker = function (t) {
		return A2(
			$elm_explorations$test$Shrink$map,
			function (x) {
				return A2($author$project$TemperatureConverter$Temperature, x, $author$project$TemperatureConverter$Kelvin);
			},
			$elm_explorations$test$Shrink$float(t.value));
	};
	var generator = A2(
		...
		A2($elm$random$Random$float, $author$project$TemperatureConverter$absolute_min_temp.value, $author$project$TemperatureConverter$absolute_max_temp.value));
	return A2($elm_explorations$test$Fuzz$custom, generator, shrinker);
}();
...
var $author$project$TemperatureConverterTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'The TemperatureConverter module',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v0) {
						return A2(
							...
							A2($author$project$TemperatureConverter$convertTemp, $author$project$TemperatureConverter$absolute_min_temp, $author$project$TemperatureConverter$DegreesCelsius),
							A2($author$project$TemperatureConverter$Temperature, -273.15, $author$project$TemperatureConverter$DegreesCelsius));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'0 °C is 32 °F',
					function (_v1) {
						return A3(
							...
							$author$project$TemperatureConverterTest$accuracy,
							32,
							A2(
								$author$project$TemperatureConverter$convertTemp,
								A2($author$project$TemperatureConverter$Temperature, 0, $author$project$TemperatureConverter$DegreesCelsius),
								$author$project$TemperatureConverter$DegreesFahrenheit).value);
					}),
					A2(
					$elm_explorations$test$Test$test,
					'0°F is 255.37_2_ K',
					function (_v2) {
						return A3(
							...
							A2(
								$author$project$TemperatureConverter$convertTemp,
								A2($author$project$TemperatureConverter$Temperature, 0, $author$project$TemperatureConverter$DegreesFahrenheit),
								$author$project$TemperatureConverter$Kelvin).value);
					}),
					A3(
					$elm_explorations$test$Test$fuzz,
					$author$project$TemperatureConverterTest$fuzzyKelvin,
					'min K to max K to °C',
					function (k) {
						return A3(
							$elm_explorations$test$Expect$within,
							$author$project$TemperatureConverterTest$accuracy,
							k.value - 273.15,
							A2($author$project$TemperatureConverter$convertTemp, k, $author$project$TemperatureConverter$DegreesCelsius).value);
					}),
					A3(
					$elm_explorations$test$Test$fuzz,
					$author$project$TemperatureConverterTest$fuzzyDegreesCelsius,
					'min °C to max °C to K',
					function (c) {
						return A3(
							$elm_explorations$test$Expect$within,
							$author$project$TemperatureConverterTest$accuracy,
							c.value + 273.15,
							A2($author$project$TemperatureConverter$convertTemp, c, $author$project$TemperatureConverter$Kelvin).value);
					}),
					A3(
					$elm_explorations$test$Test$fuzz,
					$author$project$TemperatureConverterTest$fuzzyKelvin,
					...
					function (k) {
						return A3(
							...
							$author$project$TemperatureConverterTest$accuracy,
							((k.value * 9) / 5) - 459.67,
							A2($author$project$TemperatureConverter$convertTemp, k, $author$project$TemperatureConverter$DegreesFahrenheit).value);
					}),
					A3(
					$elm_explorations$test$Test$fuzz,
					$author$project$TemperatureConverterTest$fuzzyDegreesFahrenheit,
					'min °F to max °F to K',
					function (f) {
						return A3(
							$elm_explorations$test$Expect$within,
							$author$project$TemperatureConverterTest$accuracy,
							((f.value + 459.67) * 5) / 9,
							A2($author$project$TemperatureConverter$convertTemp, f, $author$project$TemperatureConverter$Kelvin).value);
					})
				]))
		]));
var $author$project$Test$Generated$Main978072921$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/juan/Development/elm-tag/elmo-world/tests/TemperatureConverterTest.elm']),
		processes: 4,
	...
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$author$project$TemperatureConverterTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main978072921':{'init':$author$project$Test$Generated$Main978072921$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11159.sock";
